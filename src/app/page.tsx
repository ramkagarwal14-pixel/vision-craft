          ...
          <div className={styles.categoryIcons}>
            <Link href="/shop?type=reading" className={styles.iconCard}>
              <div className={styles.iconCircle}>
                <Image src="https://images.unsplash.com/photo-1505236858219-8359eb29e329?q=80&w=200&auto=format&fit=crop" alt="Reading" fill />
              </div>
              <span>Reading Glasses</span>
            </Link>
            <Link href="/shop?type=computer" className={styles.iconCard}>
              <div className={styles.iconCircle}>
                <Image src="https://images.unsplash.com/photo-1572635196237-14b3f281503f?q=80&w=200&auto=format&fit=crop" alt="Computer" fill />
              </div>
              <span>Computer Glasses</span>
            </Link>
            <Link href="/shop?type=sunglasses" className={styles.iconCard}>
              <div className={styles.iconCircle}>
                <Image src="https://images.unsplash.com/photo-1580643668142-265d03d70da2?q=80&w=200&auto=format&fit=crop" alt="Sunglasses" fill />
              </div>
              <span>Sunglasses</span>
            </Link>
            <Link href="/shop?type=contact" className={styles.iconCard}>
              <div className={styles.iconCircle}>
                <Image src="https://images.unsplash.com/photo-1590005354167-6da97870c757?q=80&w=200&auto=format&fit=crop" alt="Contacts" fill />
              </div>
              <span>Contact Lenses</span>
            </Link>
            <Link href="/shop?type=kids" className={styles.iconCard}>
              <div className={styles.iconCircle}>
                <Image src="https://images.unsplash.com/photo-1611312449408-fcece27cdbb7?q=80&w=200&auto=format&fit=crop" alt="Kids" fill />
              </div>
              <span>Kids Glasses</span>
            </Link>
            <Link href="/shop?type=progressive" className={styles.iconCard}>
              <div className={styles.iconCircle}>
                <Image src="https://images.unsplash.com/photo-1612694790876-bec1383fbb40?q=80&w=200&auto=format&fit=crop" alt="Progressive" fill />
              </div>
          ...
          <div className={styles.shapeGrid}>
            <Link href="/shop?shape=Aviator" className={styles.shapeCard}>
              <div className={styles.shapeImageWrap}>
                <Image src="https://images.unsplash.com/photo-1618361730040-30f14d87216a?q=80&w=400&auto=format&fit=crop" alt="Aviator" fill className={styles.shapeImg} />
            ...
            <Link href="/shop?shape=Wayfarer" className={styles.shapeCard}>
              <div className={styles.shapeImageWrap}>
                <Image src="https://images.unsplash.com/photo-1667067822941-69234efc2c54?q=80&w=400&auto=format&fit=crop" alt="Wayfarer" fill className={styles.shapeImg} />
                <div className={styles.shapeOverlay} />
              </div>
            ...
            <Link href="/shop?shape=Round" className={styles.shapeCard}>
              <div className={styles.shapeImageWrap}>
                <Image src="https://images.unsplash.com/photo-1684854001420-6cfed609fdf2?q=80&w=400&auto=format&fit=crop" alt="Round" fill className={styles.shapeImg} />
                <div className={styles.shapeOverlay} />
              </div>
            ...
            <Link href="/shop?shape=Cat Eye" className={styles.shapeCard}>
              <div className={styles.shapeImageWrap}>
                <Image src="https://images.unsplash.com/photo-1714356590155-f896e15d21c9?q=80&w=400&auto=format&fit=crop" alt="Cat Eye" fill className={styles.shapeImg} />
                <div className={styles.shapeOverlay} />
              </div>
            ...
            <Link href="/shop?shape=Square" className={styles.shapeCard}>
              <div className={styles.shapeImageWrap}>
                <Image src="https://images.unsplash.com/photo-1749183778702-bdf9e92253e6?q=80&w=400&auto=format&fit=crop" alt="Square" fill className={styles.shapeImg} />
                <div className={styles.shapeOverlay} />
              </div>
            ...
            <Link href="/shop?shape=Rectangle" className={styles.shapeCard}>
              <div className={styles.shapeImageWrap}>
                <Image src="https://images.unsplash.com/photo-1516714819001-8ee7a13b71d7?q=80&w=400&auto=format&fit=crop" alt="Rectangle" fill className={styles.shapeImg} />
                <div className={styles.shapeOverlay} />
              </div>
            ...
            <Link href="/shop?shape=Oversized" className={styles.shapeCard}>
              <div className={styles.shapeImageWrap}>
                <Image src="https://images.unsplash.com/photo-1529692236671-f1f6cf9683ba?q=80&w=400&auto=format&fit=crop" alt="Oversized" fill className={styles.shapeImg} />
                <div className={styles.shapeOverlay} />
              </div>
            ...
            <Link href="/shop?shape=Geometric" className={styles.shapeCard}>
              <div className={styles.shapeImageWrap}>
                <Image src="https://images.unsplash.com/photo-1594897030264-ab7d87efc473?q=80&w=400&auto=format&fit=crop" alt="Geometric" fill className={styles.shapeImg} />
                <div className={styles.shapeOverlay} />
              </div>
          ...
          <div className={styles.categoryGrid}>
            <div className={styles.categoryCard}>
              <div className={styles.categoryImage}>
                <Image src="https://images.unsplash.com/photo-1606277983151-5da30fe7036a?q=80&w=2000&auto=format&fit=crop" alt="Men's" fill />
              </div>
            ...
            <div className={styles.categoryCard}>
              <div className={styles.categoryImage}>
                <Image src="https://images.unsplash.com/photo-1618256241472-a169ebbd7dd5?q=80&w=2000&auto=format&fit=crop" alt="Women's" fill />
              </div>
              <div className={styles.categoryContent}>
                <h2>For Women</h2>
            ...
            <div className={styles.categoryCard}>
              <div className={styles.categoryImage}>
                <Image src="https://images.unsplash.com/photo-1567472221856-705c090c88f0?q=80&w=2000&auto=format&fit=crop" alt="Unisex" fill />
              </div>
              <div className={styles.categoryContent}>
                <h2>Essence</h2>
          ...
          <div className={styles.vtoContent}>
            ...
            <div className={styles.vtoPreview}>
              <div className={styles.vtoImageContainer}>
                <Image src="https://images.unsplash.com/photo-1634795776422-5a85c8e0f1ce?q=80&w=2000&auto=format&fit=crop" alt="VTO Preview" fill className={styles.vtoImage} />
              </div>
            </div>
          </div>
        </div>
